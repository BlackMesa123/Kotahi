...
public class ProgressDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mProgressStyle == STYLE_HORIZONTAL) {
            ...
            mContentView = inflater.inflate(io.mesalabs.oneui.R.layout.oui_dialog_progress_dialog_horizontal, null);
            ...
            View view = inflater.inflate(io.mesalabs.oneui.R.layout.oui_dialog_progress_dialog_circle, null);
            mProgress = (SeslProgressBar) view.findViewById(R.id.progress);
            mMessageView = (TextView) view.findViewById(R.id.message);
            setView(view);
        } else {
            View view = inflater.inflate(io.mesalabs.oneui.R.layout.oui_dialog_progress_dialog_spinner, null);
            mProgress = (SeslProgressBar) view.findViewById(R.id.progress);
            mMessageView = (TextView) view.findViewById(R.id.message);
            setView(view);
        }
